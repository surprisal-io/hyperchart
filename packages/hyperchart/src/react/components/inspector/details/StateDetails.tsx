				...
				<Section title={state.type === "waitFor" ? "Wait For" : "Notify"} icon={BellIcon} defaultOpen>
					<div className="space-y-2 rounded-lg border border-amber-500/20 bg-amber-500/5 p-2">
						<div className="flex flex-wrap items-center gap-1.5 text-[10px]">
							...
							<code className="rounded border border-amber-500/30 bg-amber-500/10 px-1.5 py-0.5 text-[var(--hc-amber-text)]">
								{state.completion.endpoint}
							</code>
							<span className="text-[var(--text-muted)]">event</span>
							<code className="rounded border border-cyan-500/30 bg-cyan-500/10 px-1.5 py-0.5 text-[var(--hc-cyan-text)]">

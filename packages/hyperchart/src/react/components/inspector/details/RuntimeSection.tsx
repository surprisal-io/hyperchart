			...
			>
				...
				{actorOccurrence !== undefined && (
					<div className="grid gap-2">
						...
						{actorOccurrence.cancellation !== undefined && <div className="rounded border border-red-500/25 p-2 text-[10px]">Cancellation requested: {String(actorOccurrence.cancellation.requested)} · acknowledged: {String(actorOccurrence.cancellation.acknowledged)}</div>}
					</div>
				)}

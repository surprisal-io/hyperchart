...
const stamp = (seqId: number) => ({ seqId, parentId: seqId === 1 ? null : seqId - 1, branchId: "main", timestamp: Date.UTC(2026, 7, 31, 19) + seqId * 1_000 });
export const plainScenario = storyScenario(chart({
	kind: "chart",

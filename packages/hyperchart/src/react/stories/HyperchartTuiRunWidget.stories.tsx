...
const meta = {
	...
	parameters: {
		layout: "fullscreen",
		docs: {
			description: { component: "The actual compact RunWidget backed by the same production-shaped run fixture." },
		},
	},
	args: {
		kind: "widget",
...
export const LiveRun: Story = {
	render: (args) => (
		<BoardPage
			title="TUI · Run widget"
			description="Компактный production widget с активной scout session и path-aware прогрессом в процентах."
		>
...
export const ManyActiveStates: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Eight concurrently running map instances with the shared path-aware percentage estimate.",
			},
		},
	},
	play: async ({ canvasElement }) => {
...
export const WidthMatrix: Story = {
	...
	render: (args) => (
		<BoardPage
			title="Run widget · many active states"
			description="Восемь одновременных states на 60, 80 и 120 колонках."
		>
